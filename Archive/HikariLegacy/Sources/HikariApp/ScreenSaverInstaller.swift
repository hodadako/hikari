...
struct ScreenSaverInstaller {
    ...
    var contentContainerURL: URL {
        fileManager.homeDirectoryForCurrentUser
            .appendingPathComponent(
                "Library/Containers/com.apple.ScreenSaver.Engine.legacyScreenSaver/Data/Library/Application Support/Hikari",
                isDirectory: true
            )
    }
    ...
    var installedURL: URL {
        fileManager.homeDirectoryForCurrentUser
            ...
            .appendingPathComponent("Hikari.saver", isDirectory: true)
    }
    ...
    var isSelected: Bool {
        guard
            let module = currentHostValue(forKey: "moduleDict")
                as? [String: Any],
            module["moduleName"] as? String == "Hikari",
    ...
    func install() throws {
        guard let bundledURL = bundledScreenSaverURL else {
            throw HikariError.screenSaverBundleMissing
        }
    ...
    private var bundledScreenSaverURL: URL? {
        let candidates = [
            Bundle.main.builtInPlugInsURL?.appendingPathComponent("Hikari.saver"),
            Bundle.main.url(forResource: "Hikari", withExtension: "saver")
        ]
    ...
    /// installed saver is replaced.  Stop only Hikari's selected host after a
